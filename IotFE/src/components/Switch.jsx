...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  width: 124, // Doubled width
  height: 68, // Doubled height
  padding: 7,
  '& .MuiSwitch-switchBase': {
    margin: 1,
    padding: 0,
    transform: 'translateX(10px)', // Adjust to fit new size
    '&.Mui-checked': {
      color: '#fff',
      transform: 'translateX(52px)', // Adjust to fit new size
  ...
  '& .MuiSwitch-thumb': {
    ...
    width: 60, // Doubled width
    height: 60, // Doubled height
    '&::before': {
      content: "''",
      position: 'absolute',
      width: '100%',
  ...
  '& .MuiSwitch-track': {
    opacity: 1,
    backgroundColor: theme.palette.mode === 'dark' ? '#8796A5' : '#aab4be',
    borderRadius: 34 / 2, // Adjust to fit new size
  },
}));
